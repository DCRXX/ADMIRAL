...
export const slidesData = [
    ...
    },
    {
        ...
        description: "Наши ребята выиграли серебряный плей-офф чемпионата MCL сезона зима 2025–2026. Спасибо команде за характер, а родителям за поддержку! Двигаемся дальше!",
        image: imagesById[3]
    },
